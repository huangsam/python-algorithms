...
def test_search_found_good(simple_trie, word: str):
...
def test_search_found_bad(simple_trie, word: str):
    found, node = simple_trie.search(word)
...
def test_search_not_found(simple_trie, word: str):
    found, node = simple_trie.search(word)
    assert found is False
    assert node is None
